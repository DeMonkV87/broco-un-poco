...
def task_1():
    return [i for i in range(1,11,1)]
...
# CODUL TĂU VINE MAI JOS:
def task_2():
    return [i**2 for i in range(1,11,1)]
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
def task_3():
    return [i for i in range(1,11) if i % 2 ==1]
# CODUL TĂU VINE MAI SUS:
...
def task_4(matrice):
    ...
    for sublist in matrice:
        lista_aplatizata.extend(sublist)
...
# CODUL TĂU VINE MAI JOS:
def task_5(n):
    return [(str("par") if i%2 == 0 else str("impar")) for i in range(1, n + 1,1)]
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
def task_6(n):
    return dict((n,n**3) for n in range(1,n+1,1))
# CODUL TĂU VINE MAI SUS:
