...
class Produs:
    ...
    def afiseaza_informatii(self):
        print(f"Denumirea produsului: {self.numele}, Pretul este de {self.pretul} lei, Anul productiei este {self.anul_producerii}")
telefon = Produs("Iphone", 15000, 2020)
telefon.afiseaza_informatii()
...
class Telefon(Produs):
    ...
    def afiseaza_informatii(self):
        ...
        print(f"Bateria telefonului este de {self.baterie_mAh} mAh, Memoria telefonului este de {self.memorie_GB} GB") 

telefon = Telefon("Iphone", 15000, 2020, 4000, 64)
telefon.afiseaza_informatii()
telefon.upgrade_memory(128), telefon.upgrade_battery(5600)
telefon.afiseaza_informatii()
# CODUL TĂU VINE MAI SUS:
